...
export default function RegisterArchive() {
    ...
    <div className="max-w-7xl mx-auto space-y-16 pb-32 px-4 md:px-0">
            ...
            <div className="bg-white p-16 text-center space-y-8 border border-zinc-100 shadow-2xl">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[10px] tracking-[0.4em] uppercase text-zinc-400 font-black">
                  Archive successfully recorded in digital bounty
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pb-10 border-b border-zinc-100">
        ...
        >
          ...
          {loading ? "COMMITTING..." : "Commit to Vault"}
        </button>
      </div>
        ...
        <div className="lg:col-span-4 space-y-12">
          ...
          <section className="bg-white border border-zinc-100 p-10 space-y-8 shadow-sm">
            ...
            <div className="space-y-6">
              <div className="aspect-3/4 bg-zinc-50 border border-dashed border-zinc-200 flex flex-col items-center justify-center gap-4 group hover:bg-zinc-100 hover:border-black cursor-pointer transition-all duration-500 overflow-hidden relative">
                <div className="w-14 h-14 rounded-full bg-zinc-200 flex items-center justify-center text-zinc-400 group-hover:bg-black group-hover:text-white transition-all scale-100 group-hover:scale-110">
                  <Plus size={24} />
                </div>
                <div className="text-center">
                  <p className="text-[10px] tracking-[0.3em] uppercase font-black text-zinc-400 group-hover:text-black transition-colors">
                    Primary Asset
                  </p>
                  <p className="text-[8px] tracking-widest text-zinc-300 mt-2 uppercase">
                    RAW / 4K / 3:4
                  </p>
                </div>

                {/* Hover Gradient */}
                <div className="absolute inset-0 bg-linear-to-t from-black/5 flex items-end justify-center p-6 opacity-0 group-hover:opacity-100 transition-opacity">
                  <span className="text-[9px] tracking-[0.4em] font-black text-black">
                    DRAG & DEPLOY
                  </span>
                </div>
              </div>
